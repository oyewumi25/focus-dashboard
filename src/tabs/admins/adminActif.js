...
import { base_url,getAllAdminsActifs} from "../../constants/url"
import { openNotification } from "../../functions/notification";
import { connect } from "react-redux";


class adminActif extends Component {
  state = {
    searchText: "",
    searchedColumn: "",
  ...
  fetchData = async () => {
    await Axios.get(base_url + getAllAdminsActifs)
      .then((res) => {      
...
export default connect(mapStateToProps, mapDispatchStoreToProps)(adminActif);
