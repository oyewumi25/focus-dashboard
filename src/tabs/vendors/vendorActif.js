...
import {base_url, getAllVendorsActifs} from "../../constants/url"
...
class vendorActif extends Component {
  state = {
    searchText: "",
    searchedColumn: "",
  ...
  fetchData = async () => {
    await Axios.get(base_url + getAllVendorsActifs)
      .then((res) => {
  ...
  render() {
    ...
    const columns = [
...

      {
        ...
        ...getColumnSearchProps("withdrawed")
      },

      // {
      //   title: "Comission",
      //   dataIndex: "comission",
      //   ...getColumnSearchProps("comission")
      // },
...
export default connect(mapStateToProps, mapDispatchStoreToProps)(vendorActif);
