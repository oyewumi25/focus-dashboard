...
import Sub_Sub_Category_new from "../../forms/sub_sub_category"

class   Sub_Sub_Category extends Component {
  state = {
    searchText: "",
    searchedColumn: "",
...
export default connect(mapStateToProps, mapDispatchStoreToProps)(Sub_Sub_Category );
