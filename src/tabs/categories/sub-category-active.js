...
import { base_url,getAllSubCategoriesActifs} from "../../constants/url"
import { openNotification } from "../../functions/notification";

class subcategoryActive extends Component {
  state = {
    searchText: "",
    searchedColumn: "",
  ...
  fetchData = async () => {
    await Axios.get(base_url + getAllSubCategoriesActifs)
      .then((res) => {      
...
export default connect(mapStateToProps, mapDispatchStoreToProps)(subcategoryActive);
