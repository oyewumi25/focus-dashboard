...
import { base_url,getAllCategoriesInactifs} from "../../constants/url"
import { openNotification } from "../../functions/notification";

class categoryInactive extends Component {
  state = {
    searchText: "",
    searchedColumn: "",
  ...
  fetchData = async () => {
    await Axios.get(base_url + getAllCategoriesInactifs)
      .then((res) => {      
...
export default connect(mapStateToProps, mapDispatchStoreToProps)(categoryInactive);
