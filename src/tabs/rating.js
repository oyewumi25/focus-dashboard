...
import { base_url,getAllRating} from "../constants/url"
...
class Rating extends Component {
  ...
  fetchData = async () => {
    await Axios.get(base_url +getAllRating )
      .then((res) => {
...
export default connect(mapStateToProps, mapDispatchStoreToProps)(Rating);
